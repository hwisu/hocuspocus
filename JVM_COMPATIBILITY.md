...
stateless messages, persistence, and reconnect behavior.
...
The source dependency is YKS `0.2.11` at
`b98bccf52a2560bff6a48aa97fc95e7566778db6`. Hocuspocus uses only standard Yjs
